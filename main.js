...
const rules = [
        ...
        'Не скачивать любое СЗ(только дайвинчик).',
        ...
        'Не пользоваться поиском в Telegram.',
...
let dayBB = moment();
const dayA = moment("2022-10-23 20:34",       "YYYY-MM-DD HH:mm"),
      dayB = moment("2022-11-01 20:34",       "YYYY-MM-DD HH:mm");
